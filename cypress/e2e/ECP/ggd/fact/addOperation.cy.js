...
it('ggdFactAddOperation', () => {
    ...
    cy.get(':nth-child(5) > .ant-select-dropdown > :nth-child(1) > :nth-child(1) > [style="position: absolute; top: 5px; right: 15px; z-index: 500;"] > .ant-segmented > .ant-segmented-group > :nth-child(2) > .ant-segmented-item-label > .ant-segmented-item-icon').click()
