...
it('tfOrientation_importAddToOld', () => {
...
cy.get('span > input[type="file"]').eq(0).selectFile("C:\\Users\\admin\\Desktop\\ECP\\cypress\\filesForAutoTests\\tfOrientation.xlsx", {force: true})
